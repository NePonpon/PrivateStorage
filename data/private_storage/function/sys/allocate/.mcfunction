...
execute store success storage private_storage:sys provided_id_table[-1].is_player byte 1 if entity @s[type=minecraft:player] run function private_storage:sys/allocate/player/
