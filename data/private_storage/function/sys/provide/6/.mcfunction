...
execute store result storage private_storage:sys provide.target int 1 run data get storage private_storage:sys provide_id 268435456
...
function private_storage:sys/provide/6/shift with storage private_storage:macro provide
