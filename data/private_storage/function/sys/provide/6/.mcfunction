...
execute unless data storage private_storage: _[-8][-8][-8][-8][-8][0] run data modify storage private_storage: _ set from storage private_storage:sys inital[0][0][0][0][0]
