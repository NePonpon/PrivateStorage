...
execute store result storage private_storage:sys provide.target int 1 run data get storage private_storage:sys provide_id 4194304
...
execute unless data storage private_storage: _[-8][-8][-8][0] run data modify storage private_storage: _ set from storage private_storage:sys initial[0][0][0]
