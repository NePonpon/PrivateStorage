...
execute store result storage private_storage:sys provide.target byte 16 run data get storage private_storage:sys provide_id 0.000244140625
...
execute if data storage private_storage:sys {flag:0b} run data modify storage private_storage: _[-8] append from storage private_storage:sys shift.first[]
execute if data storage private_storage:sys {flag:1b} run data modify storage private_storage: _[-8] append from storage private_storage:sys shift.end[]
