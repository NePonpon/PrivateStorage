...
# UUIDから検索してidを抽出
# こっちのほうが楽かもしれない
data modify storage private_storage:macro allocate_player.id set string storage private_storage:sys provide.rename_player.modifier_ids[{UUID:[I;-1163525954,1887718507,-1820030162,821945443]}].Name 19
